...
var taskInput=document.querySelector(".input__new-task");//Add a new task.
var addButton=document.getElementsByTagName("button")[0];//first button
var incompleteTaskHolder=document.querySelector(".section-todo__list");//ul of #incompleteTasks
...
var createNewTaskElement=function(taskString){
    ...
    checkBox.className="input input_checkbox list__input";
    editInput.type="text";
    editInput.className="input input_text list__input list__input_text";
